...
#		for rad in $(echo $@) # default: $@ = " RRTM CCM "
	...
	do
		...
		if [ "$i" -lt $1 ]; then
                ...
                rsync -arzhSPH $s ctang@titan.univ.run:/worktmp2/RegCM_DATA/Modeling/EIN15/${i}_output_${dir}_${rad}_${conv}_${moisture}_${pbl}_BATS_Zeng/$i.RAD*.MJJ*.nc $target/${i}_output_${dir}_${rad}_${conv}_${moisture}_${pbl}_bats_zeng/
                ...
                rsync -arzhSPH $s ctang@titan.univ.run:/worktmp2/RegCM_DATA/Modeling/EIN15/${i}_output_${dir}_${rad}_${conv}_${moisture}_${pbl}_BATS_Zeng/$i.RAD*NDJF*.nc $target/${i}_output_${dir}_${rad}_${conv}_${moisture}_${pbl}_bats_zeng/
		fi
	done
					((i++))
					done
